...
def main():
    ...
    train_x, train_y = train_data_loader.return_split_labels_data(True)
    ...
    train_x, train_y = new_data_loader.return_split_labels_data(True)  
    print(train_y[0])
    
    return 
    test_x, test_y = test_data_loader.return_split_labels_data() 
