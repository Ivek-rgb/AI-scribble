...
class ImageScroller:
    ...
    def __init__(self):
        ...
        self.prev_button = tkinter.Button(self.imageScroller, text="Previous", command=self.prev_image)
        self.prev_button.pack(side="left", padx=10, pady=10)

        self.next_button = tkinter.Button(self.imageScroller, text="Next", command=self.next_image)
